...
slug: build-a-resilient-asynchronous-system-with-cloud-run-and-pubsub-gsp650
cover: https://cdn.hashnode.com/res/hashnode/image/upload/v1724072783697/56eda2ae-b4c7-4fcf-b7a2-a5ea3cddd37e.png
ogImage: https://cdn.hashnode.com/res/hashnode/image/upload/v1724073260251/8520cd56-3ade-4b64-998a-27073f41de46.png
tags: build-a-resilient-asynchronous-system-with-cloud-run-and-pubsub-gsp650, gsp650
...
%[https://www.youtube.com/watch?v=WO1Yu-bcxeE] 

```apache
export REGION=
```

![](https://cdn.hashnode.com/res/hashnode/image/upload/v1724072918001/b5179079-2280-4aa2-892d-623d21c361e3.png align="center")

```apache
curl -LO raw.githubusercontent.com/quiccklabs/Labs_solutions/master/Build%20a%20Resilient%2C%20Asynchronous%20System%20with%20Cloud%20Run%20and%20Pub%3ASub/quicklabgsp650.sh
sudo chmod +x quicklabgsp650.sh
./quicklabgsp650.sh
```