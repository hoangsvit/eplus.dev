...
```plaintext
curl -LO raw.githubusercontent.com/ePlus-DEV/storage/refs/heads/main/labs/GSP048/lab.sh
source lab.sh
```
...
Type in the terminal <mark class="bg-yellow-200 dark:bg-yellow-500/30">y</mark>
