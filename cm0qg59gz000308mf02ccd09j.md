...
datePublished: 2024-09-06T08:20:50.099Z
cuid: cm0qg59gz000308mf02ccd09j
slug: prepare-data-for-looker-dashboards-and-reports-challenge-lab-gsp346
cover: https://cdn.hashnode.com/uploads/covers/5f802df9bbabf10ec84d9fe8/9eabc1f7-ab0b-454d-a460-bcde0ac5cae9.png
ogImage: https://cdn.hashnode.com/uploads/og-images/5f802df9bbabf10ec84d9fe8/9168e626-6c64-4799-923d-61f7b08e73d1.png
...
**Looker → Develop →** `qwiklabs-flights` **→ New File → Dashboard →** `lab.dashboard.lookml`

![](https://cdn.hashnode.com/uploads/covers/5f802df9bbabf10ec84d9fe8/d2e1b8d7-badc-43fd-bf5b-c023ebecbe5c.png align="center")

![](https://cdn.hashnode.com/uploads/covers/5f802df9bbabf10ec84d9fe8/e9302d89-18d9-44f6-8e16-879b74c18984.png align="center")

```plaintext
- dashboard: plane_and_helicopter_rental_hub_board
  title: Plane and Helicopter Rental Hub Board
  layout: newspaper
  ...
  - name: Busiest, Major Joint-Use Airports with Control Towers
    ...
    - model: faa
      ...
      fields:
      - aircraft_origin.city
      - aircraft_origin.state
      - aircraft_origin.code
      - flights.count
  ...
  - name: Top 10 Cities With Most Heliports
    title: Top 10 Cities With Most Heliports
  ...
  - name: Facility Type Breakdown for Top 10 States
    title: Facility Type Breakdown for Top 10 States
  ...
  - name: "States and Cities with Highest Percentage of Cancellations: Flights over 10,000"
    title: "States and Cities with Highest Percentage of Cancellations: Flights over 10,000"
    ...
    - category: table_calculation
      expression: "${flights.cancelled_count}/${flights.count}"
      label: Percentage of Flights Cancelled
      table_calculation: percentage_of_flights_cancelled
  ...
  - name: Top 7 Airports With Smallest Average Distance
    title: Top 7 Airports With Smallest Average Distance
    ...
    fields:
    - flights.origin_and_destination
    - average_distance_miles

    dynamic_fields:
    - category: measure
      label: Average Distance (Miles)
      based_on: flights.distance
...
![](https://cdn.hashnode.com/uploads/covers/5f802df9bbabf10ec84d9fe8/e115771f-7f7a-4e2b-bc87-856fb9726fe7.png align="center")

![](https://cdn.hashnode.com/uploads/covers/5f802df9bbabf10ec84d9fe8/beabff1e-2244-4c8e-9a9b-30080ef2f76f.png align="center")

#### Look #2: Facility type breakdown

![](https://cdn.hashnode.com/uploads/covers/5f802df9bbabf10ec84d9fe8/98f8aef1-a603-480b-845f-f3c049550b93.png align="center")

![](https://cdn.hashnode.com/uploads/covers/5f802df9bbabf10ec84d9fe8/cdd4b170-d0e0-4f0d-9c2f-39862e13eb6e.png align="center")

#### Look #4: Smallest average distance

![](https://cdn.hashnode.com/uploads/covers/5f802df9bbabf10ec84d9fe8/96074a45-7c12-42fe-83f8-348b59724864.png align="center")

![](https://cdn.hashnode.com/uploads/covers/5f802df9bbabf10ec84d9fe8/bf391997-02ff-401a-b3d6-db26d19bc41d.png align="center")

Open file: `faa.model.lkml`

![](https://cdn.hashnode.com/uploads/covers/5f802df9bbabf10ec84d9fe8/9cfa0546-d9cc-43c0-bc5c-5f6b8595a49a.png align="center")

```plaintext
include: "/*.dashboard.lookml"
```

*Step 1: Save Changes → Validate LookML → Commit Changes & Push → Deploy to Production*

*Step 2: Folders → LookML Dashboards → Plane and Helicopter Rental Hub Board*
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1758357391644/be6b724e-e24f-4b93-89ff-a9875ae15195.png align="center")
